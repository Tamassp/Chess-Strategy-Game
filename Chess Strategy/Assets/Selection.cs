    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonUp(0))
        {
            ...
            else //marquee select
            {
                ...
                print(selectionMesh.vertices.Length);
                print(selectionMesh.vertices[0]);
                print(selectionMesh.vertices[1]);
                print(selectionMesh.vertices[2]);
                print(selectionMesh.vertices[3]);
